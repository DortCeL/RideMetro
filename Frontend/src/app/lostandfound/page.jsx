...
const LostAndFound = () => {
	const items = [
		...
		},
		{
			...
			description:
				"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ac venenatis nisl...",
			image: "/mobile.jpg",
			category: "Mobile Phones",
		},
		{
...

		{
			...
			description:
				"Mauris vitae nisi ultricies, dignissim nunc id, congue lectus. Sed id nisl at lorem iaculis ...",
			image: "/watch.jpg",
			category: "Watches",
		},
		{
			...
			description:
				"Nullam vel justo scelerisque, gravida nunc at, dapibus magna. Ut faucibus erat urna...",
			image: "/keys.jpeg",
			category: "Keys",
		},
		{
			...
			description:
				"Vivamus vel sapien eget nisl tempus aliquam et et risus. Curabitur et nisi felis...",
			image: "/keys.jpeg",
			category: "Keys",
		},
		{
			...
			description:
				"Aliquam eu erat orci. Nulla vehicula ante et euismod tincidunt. Cras non dolor leo...",
			image: "/mobile.jpg",
			category: "Mobile Phones",
		},

		{
			...
			description:
				"Quisque auctor purus vitae fermentum interdum. Integer id nunc ante. Mauris finibus ligula eu augue...",
			image: "/watch.jpg",
			category: "Watches",
		},
	];
		...
		<>
			...
			<div className='min-h-screen p-8 mt-5'>
				<div className='complain_conatiner'>
					<h1 className='text-5xl font-bold text-center text-gray-900 mb-12 graph_heading complain_dashboard'>
				...
				<div className='flex flex-col lg:flex-row gap-8'>
					...
					<div className='bg-gradient-to-t from-orange-400 to-300 bg-transparent opacity-80 w-full lg:w-1/4 p-6 shadow-2xl rounded-xl hover:border-orange-300 hover:ring-1 hover:ring-black '>
						<h2 className='text-2xl font-semibold text-gray-800 mb-6 graph_heading'>
							Categories
						</h2>
					...
					<div className='w-full lg:w-3/4 grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-8 graph_heading'>
						{filteredItems.map((item) => (
							<div
								key={item.id}
								className={`bg-white rounded-2xl shadow-2xl overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105 ${
