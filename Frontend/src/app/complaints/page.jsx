...
const ComplainBox = () => {
	...
	return (
		<>
			...
			>
				<form
					className='bg-transparent  p-6 rounded-lg shadow-lg w-full max-w-4xl mb-10 px-10 py-10'
					onSubmit={handleSubmit}
				>
					<h2 className='metro-heading text-center mb-8'>Report Your Issue</h2>

					{/* Complaint Type */}
					<label className='block mt-6 mb-3 text-cyan-50 text-xl'>
						Complaint Type
					</label>
					<select
						name='complaintType'
				...
				>
					...
					<div className='space-y-4'>
						{complaints.map((complaint) => (
							<div
								key={complaint.id}
								className='p-3 rounded-lg bg-black bg-opacity-50 border border-gray-600'
							>
